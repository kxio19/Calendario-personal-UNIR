...
Aplicación web personal para registrar y gestionar turnos, guardias y horas extras. Sincronización en tiempo real con Firebase Firestore. Diseñada para uso en móvil, instalable como aplicación nativa (PWA).

📱 Instalación (Como App)

Esta aplicación es una PWA (Progressive Web App). Puedes instalarla en tu teléfono para usarla a pantalla completa sin la barra del navegador, mejorando el rendimiento de carga gracias a su estrategia de caché:
...
Soporte PWA — Service Worker con caché para arranques rápidos e instalación en móvil.
...
Instalación móvil y gestión de caché
...
Sube los nuevos archivos al repositorio sobreescribiendo los anteriores. GitHub Pages se actualiza en 1-2 minutos. Fuerza recarga con Ctrl+Shift+R (o cerrando y abriendo la app en el móvil) si el navegador sirve la versión anterior desde caché.
